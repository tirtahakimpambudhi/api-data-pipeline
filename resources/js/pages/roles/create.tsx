...
export default function CreateRolesPage({ permissions }: PageProps) {
    ...
    const isDirty = data.name.trim() !== '' || data.description.trim() !== '' || (data.permissions_ids?.length ?? 0) > 0;
                                    ...
                                    <div key={resource} className="space-y-1 rounded-md bg-background p-2">
                                        ...
                                        <div className="mt-1 grid gap-1 sm:grid-cols-2">
                                            {perms.map((perm) => {
                                                ...
                                                // FIX: Pastikan data.permissions_ids adalah array sebelum memanggil .map()
